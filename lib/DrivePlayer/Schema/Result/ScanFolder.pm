package DrivePlayer::Schema::Result::ScanFolder;
...
__PACKAGE__->has_many(
    folders => 'DrivePlayer::Schema::Result::Folder',
    'scan_folder_id',
    { cascade_delete => 1 },
);
...
DrivePlayer::Schema::Result::ScanFolder - DBIx::Class result for the scan_folders table

=head1 DESCRIPTION

Represents a top-level Google Drive folder that the user has configured for
scanning.  Has many L<DrivePlayer::Schema::Result::Folder> children
